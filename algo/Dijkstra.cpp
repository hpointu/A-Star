...
Dijkstra::Dijkstra(CellGraph *graph, Cell::Coord startPoint, Cell::Coord endPoint) :
	Algo(graph),
...
Dijkstra::_Point* Dijkstra::getCheaper(QList<_Point *> list, int &id)
{
	int i = 0;
...
// check by coords
bool Dijkstra::inList(QList<_Point *> list, _Point *p)
{
